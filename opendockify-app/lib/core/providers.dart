...
final tokenStoreProvider = Provider<TokenStore>((ref) => throw UnimplementedError('tokenStoreProvider must be overridden in tests or wired at startup.'));

/// Persistent preferences (base URL, disclaimer flag). Overridden in tests.
final appConfigStoreProvider = Provider<AppConfigStore>((ref) => throw UnimplementedError('appConfigStoreProvider must be overridden in tests or wired at startup.'));
...
final apiClientProvider = Provider<ApiClient>((ref) {
  return ApiClient(
    baseUrl: '',
    tokens: ref.watch(tokenProvider),
  );
});